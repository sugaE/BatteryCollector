...
void ABatteryCollectorCharacter::CollectPickups(){
	...
	// for each actor collect

	for (int iCollcted = 0; iCollcted < CollectedActors.Num(); ++iCollcted){

		// cast the actor to apickup
		APickup *const TestPickup = Cast<APickup>(CollectedActors[iCollcted]);
...
void ABatteryCollectorCharacter::UpdatePower(float PowerChange){
	...
	GetCharacterMovement()->MaxWalkSpeed = BaseSpeed + BaseSpeed * CharacterPower;
	// call the blueprint implementation method
	PowerChangeEffect();
}